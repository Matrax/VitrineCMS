...
if(Admin::isConnected() && isset($_GET["url"]) && isset($_GET["container-id"]))
{
    try {
        ...
        $json[$_GET["container-id"]]["elements"][$elementId]["type"] = "navbar-button";
        $json[$_GET["container-id"]]["elements"][$elementId]["text"] = "Bouton";
        ...
        FrontLogger::error("Erreur à la création d'un bouton dans la navbar !");
    }
}