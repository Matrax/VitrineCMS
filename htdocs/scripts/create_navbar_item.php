...
if(Admin::isConnected() && isset($_GET["url"]) && isset($_GET["container-id"]))
{
    try {
        ...
        $json[$_GET["container-id"]]["elements"][$elementId]["type"] = "navbar-item";
        $json[$_GET["container-id"]]["elements"][$elementId]["text"] = "Item";
        ...
        FrontLogger::error("Erreur à la création d'un item dans la navbar !");
    }
}