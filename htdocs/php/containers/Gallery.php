...
class Gallery extends HTMLContent
{
    ...
    public function onCreateHtml() : string
    {
        ...
        {
            $this->appendHtml(<<<HTML
                <img class="gallery-image" src="{$value}" width=100% height=100%>
            HTML);
        }
    ...
    public function onCreateAdminHtml() : string
    {
        ...
        {
            $this->appendHtml(<<<HTML
                <img class="gallery-image" container-id="{$this->id}" id="{$i}" src="{$this->images[$i]}" alt="image" width=100% height=100%>
            HTML);
        }
